    ...
    <section class="ftco-section bg-light">
    	<div class="container-fluid">
          ...
          <div class="col-md-7 text-center heading-section ftco-animate">
            ...
            <h2 class="mb-4">MATHJESTIC QUEST</h2>
          </div>
        </div>
        <div class="row">
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
					...
					<br/>
	                <blockquote>
	                  <p><a href="portal_lesson.php" class="btn btn-primary py-3 px-4">PLAY!</a></p>
	                </blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <img src="images/person_1.jpg" alt="">
	                  </div>
	                  <div class="name align-self-center">CHAPTER 1 <span class="position"></span></div>
	                </div>
	              </div>
	            </div>
	          </div>
        	...
        	<div class="col-lg-3 col-sm-6">
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                <!-- back content -->
	                <blockquote>
					<p><a href="#" class="btn btn-primary py-3 px-4">PLAY!</a></p>
					</blockquote>
	                <div class="author d-flex">
	                  <div class="image mr-3 align-self-center">
	                    <img src="images/person_2.jpg" alt="">
	                  </div>
	                  <div class="name align-self-center">CHAPTER 2<span class="position"></span></div>
	                </div>
	              </div>
	            </div>
	          </div>
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  ...
	                  <div class="name align-self-center">CHAPTER 3 <span class="position"></span></div>
	                </div>
	              </div>
	            </div>
	          </div>
	            ...
	            <div class="flipper">
	              ...
	              <div class="back">
	                ...
	                <div class="author d-flex">
	                  ...
	                  <div class="name align-self-center">CHAPTER 4 <span class="position"></span></div>
	                </div>
	              </div>
	            </div>
	          </div>
