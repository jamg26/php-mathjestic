       ...
       <div class="row">
		...
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#bs-example-modal-lg">ADD QUESTION</button>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  		<?php 
								$query = mysqli_query($conn, "SELECT * FROM `ct_exam_questions` where exam_id='".$_GET['exam_id']."';") or die(mysqli_error());
                        ...
                        <tr>
                          ...
                          -->
                            <a href="function/tc_fc_examination/delete_question.php?deletani=<?php echo $id?>&examid=<?php echo $_GET['exam_id'];?>" onclick="return confirm('Do you want to delete?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
								<?php } ?>
                      </tbody>
                 ...
                 <div class="modal fade" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <br>
                    <form class="form-horizontal form-label-left input_mask" action="function/tc_fc_examination/add_question_second.php" method="POST">
                ...
                <div class="x_content">
                  ...
                  <textarea name="descr" class="form-control" row="100" id="descr" style="margin: 0px; width: 823px; height: 324px;;"></textarea>
                   <input type="hidden" class="form-control" value="<?php echo $_GET['exam_id'];?>" name="getthequizid" size="60">
