       ...
       <div class="row">
		...
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#bs-example-modal-lg">ADD QUESTION</button>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  		<?php 
								$query = mysqli_query($conn, "SELECT * FROM `ct_quiz_questions` where quiz_id='".$_GET['quiz_id']."';") or die(mysqli_error());
                        ...
                        <tr>
                          ...
                          -->
                            <a href="function/tc_fc_quiz/delete_question.php?deletani=<?php echo $id?>&quizid=<?php echo $_GET['quiz_id'];?>" onclick="return confirm('Do you want to delete?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
								<?php } ?>
                      </tbody>
                 ...
                 <div class="modal fade" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <br>
                    <form class="form-horizontal form-label-left input_mask" action="function/tc_fc_quiz/add_question_second.php" method="POST">
