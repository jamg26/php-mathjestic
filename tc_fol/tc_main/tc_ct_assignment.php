    ...
    <div class="container body">
      <div class="main_container">
       ...
       <div class="row">
		...
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#bs-example-modal-sm">Create Assignment</button>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  		<?php 
								$query = mysqli_query($conn, "SELECT * FROM `ct_assignment` where id_for_teacher_as='".$_SESSION['tc_id']."';") or die(mysqli_error());
                        ...
                        <tr>
                          ...
                          <td>
                            ...
                            <a href="tc_ct_assignment_view.php?assignment_id=<?php echo $id;?>&ahekdnsakmak8dasjkn34df" class="btn btn-primary btn-xs"><i class="fa fa-folder"></i> View </a>
                             
                            <a href="#edita<?php echo $id;?>" class="btn btn-primary btn-xs" data-toggle="modal"><i class="fa fa-pencil"></i> Edit </a>
                          
                            <a href="function/tc_fc_assignment/delete_assignment.php?idassignment=<?php echo $id;?>" onclick="return confirm('Do you want to delete?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
								<?php } ?>
                      </tbody>
                 ...
                 <div class="modal fade" id="bs-example-modal-sm" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <br>
                    <form class="form-horizontal form-label-left input_mask" action="function/tc_fc_assignment/add_assignment.php" method="POST">
				    ...
				    <!------===============addddttttttooooooooooooo==========--------->
				     		...
				     		<?php 
								$query = mysqli_query($conn, "SELECT * FROM `ct_assignment`;") or die(mysqli_error());
								while($fetch = mysqli_fetch_array($query))
								{
										$id = $fetch['assignment_id'];
										$name = $fetch['name'];
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Add Assignment to:</h4>
                        </div>
                        <div class="modal-body">  
                    <br>
			 ...
			 <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
					...
					<?php 
					$selectifexist = mysqli_query($conn, "select *from ct_addto where assid='$id';") or die(mysqli_error()); 
                    ...
                    <div class="modal-dialog modal-sm">
                      <div class="modal-content">
                        ...
                        <div class="modal-header">
                          ...
                          <h4 class="modal-title" id="myModalLabel2">Edit Assignment</h4>
                        </div>
                        <div class="modal-body">  
                    <br>
                    <form class="form-horizontal form-label-left input_mask" action="function/tc_fc_assignment/edit_assignment.php" method="POST">

                      <div class="col-md-12 col-sm-12 col-xs-12 form-group has-feedback">
                        <input type="hidden" class="form-control has-feedback-left" id="inputSuccess2" name="id" value="<?php echo $id;?>" placeholder="Quiz Title" required>
