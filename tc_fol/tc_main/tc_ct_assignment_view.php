       ...
       <div class="row">
		...
		<button type="button" class="btn btn-success" data-toggle="modal" data-target="#bs-example-modal-lg">ADD QUESTION</button>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  		<?php 
								$query = mysqli_query($conn, "SELECT * FROM `ct_assignment_questions` where assignment_id='".$_GET['assignment_id']."';") or die(mysqli_error());
                        ...
                        <tr>
                          ...
                          -->
                            <a href="function/tc_fc_assignment/delete_question.php?deletani=<?php echo $id?>&assignmentid=<?php echo $_GET['assignment_id'];?>" onclick="return confirm('Do you want to delete?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o"></i> Delete </a>
                          </td>
                        </tr>
								<?php } ?>
                      </tbody>
                 ...
                 <div class="modal fade" id="bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
                    ...
                    <br>
                    <form class="form-horizontal form-label-left input_mask" action="function/tc_fc_assignment/add_question_second.php" method="POST">
                ...
                <div class="x_content">
                  ...
                  <textarea name="descr" class="form-control" row="100" id="descr" style="margin: 0px; width: 823px; height: 324px;;"></textarea>
                   <input type="hidden" class="form-control" value="<?php echo $_GET['assignment_id'];?>" name="getthequizid" size="60">
