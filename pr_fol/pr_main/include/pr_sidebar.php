        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="index.php" class="site_title"><i class="fa fa-paw"></i> <span>CALM | Parent</span></a>
            </div>
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> Home <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="pr_my_student.php">My Student</a></li>
                    </ul>
                  </li>
                  <li><a><i class="fa fa-bar-chart"></i> Student Progress <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="pr_sp_progress.php">Progress</a></li>
                  ...
                  <li><a><i class="fa fa-calendar"></i> School Calendar <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="pr_school_calendar.php">What's New?</a></li>
                    </ul>
                  </li>
                </ul>
              </div>
