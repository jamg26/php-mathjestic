              ...
              <div class="col-md-12">
                ...
                <div class="buttons">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      ...
                      <tbody>
					  		<?php 
								$query = mysqli_query($conn, "SELECT * FROM `usr_parent` order by pr_stat DESC;") or die(mysqli_error());
								while($fetch = mysqli_fetch_array($query))
								{
										...
										$date = $fetch['pr_entry_date']; 
										$status = $fetch['pr_stat']; 
										$user = $fetch['username']; 
                        ...
                        <div class="profile_pic">
                          ...
                          <td> 
                            <a href="function/admin_pr_verify.php?yes=<?php echo $id;?>" onclick="return confirm('Do you want to verify this user?');" class="btn btn-success btn-xs"> Verify </a>
                          </td>
                        </tr>
								<?php } ?>
                      </tbody>
