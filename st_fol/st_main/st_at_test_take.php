                  ...
                  <div class="x_title">
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        <?php $count=0;
						$q_id=$_GET['test_id'];
							$querys = mysqli_query($conn, "SELECT * FROM `ct_test_questions`where test_id='$q_id';") or die(mysqli_error());
						...
						<?php } ?>
						<br/>
						<form action="function/st_fc_test/st_submit_answer.php?test_id=<?php echo $q_id; ?>" method="POST">
