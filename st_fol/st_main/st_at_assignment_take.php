                  ...
                  <div class="x_title">
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        <?php $count=0;
						$q_id=$_GET['assignment_id'];
							$querys = mysqli_query($conn, "SELECT * FROM `ct_assignment_questions`where assignment_id='$q_id';") or die(mysqli_error());
						...
						<?php } ?>
						<br/>
						<form action="function/st_fc_assignment/st_submit_answer.php?assignment_id=<?php echo $q_id; ?>" method="POST">
