          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>My Activities <small>List </small></h3>
              </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p>Click the action button named "Take Activity" as the teacher give the Activities.</p>
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
								...
								{ 
								$querys = mysqli_query($conn, "SELECT * FROM `ct_activity` where activity_id='".$rows['actid']."';") or die(mysqli_error());
								...
								<?php
								$queryselect = mysqli_query($conn, "SELECT * FROM `ct_activity_records`where student='".$_SESSION['st_id']."' and activity_id='$actid';") or die(mysqli_error());
								if($rower = mysqli_fetch_array($queryselect))
								{ ?>
							<td> <a class="btn btn-warning btn-xs"> You Already Take the Activity </a></td>
								
								 <?php }else{?>
								<td> <a href="../st_main/st_activity_attempt.php?activity_id=<?php echo $row['activity_id'];?>" class="btn btn-primary btn-xs"> Take Activity </a></td>
									    <?php } ?>
								</tr> 
							    <?php } } ?>
