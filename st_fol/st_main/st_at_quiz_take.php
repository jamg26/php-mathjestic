                  ...
                  <div class="x_title">
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        <?php $count=0;
						$q_id=$_GET['quiz_id'];
							$querys = mysqli_query($conn, "SELECT * FROM `ct_quiz_questions`where quiz_id='$q_id';") or die(mysqli_error());
						...
						<?php } ?>
						<br/>
						<form action="function/st_fc_quiz/st_submit_answer.php?quiz_id=<?php echo $q_id; ?>" method="POST">
							...
							while($row = mysqli_fetch_array($querys))
							{
							 ...
							 if($question_type=='1')
							 {
								...
								<div class="tab-pane <?php echo $aa; ?>" id="aa<?php echo $question_id; ?>">
								  ...
								  <p>Question: <?php echo $question; ?></p><br>
