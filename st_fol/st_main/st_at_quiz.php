          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>My Quizzes <small>List</small></h3>
              </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <p>Click the action button named "Take quiz" as the teacher give the quizzes.</p>
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
								...
								{ 
								$querys = mysqli_query($conn, "SELECT * FROM `ct_quiz` where quiz_id='".$rows['quizID']."';") or die(mysqli_error());
								...
								<?php
								$queryselect = mysqli_query($conn, "SELECT * FROM `ct_quiz_records`where student='".$_SESSION['st_id']."' and quiz_id='$qid';") or die(mysqli_error());
								if($rower = mysqli_fetch_array($queryselect))
								{ ?>
							<td> <a class="btn btn-warning btn-xs"> You Already Take the quiz </a></td>
								
								 <?php }else{?>
								 <td> <a href="../st_main/st_at_quiz_take.php?quiz_id=<?php echo $row['quiz_id'];?>" class="btn btn-primary btn-xs"> Take quiz </a></td>
