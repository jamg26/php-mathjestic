                  ...
                  <div class="x_title">
                    ...
                    <div class="col-xs-3">
                      ...
                      <ul class="nav nav-tabs tabs-left">
                        <?php $count=0;
						$q_id=$_GET['quiz_id'];
							$querys = mysqli_query($conn, "SELECT * FROM `clm_questions`where quiz_id='$q_id';") or die(mysqli_error());
						...
						<?php } ?>
						<br/>
						<form action="function/st_submit_answer.php?quiz_id=<?php echo $q_id; ?>" method="POST">
