          ...
          <div class="">
            <div class="page-title">
              <div class="title_left">
                <h3>My Assignment <small>List</small></h3>
              </div>
              ...
              <div class="col-md-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                       ...
                       <p>Click the action button named "Take Assignment" as the teacher give the assignment.</p>
                    ...
                    <table class="table table-striped projects">
                      ...
                      <tbody>
								...
								{
								$querys = mysqli_query($conn, "SELECT * FROM `ct_assignment` where assignment_id='".$rows['assid']."';") or die(mysqli_error());
								...
								<td><?php echo $row['total_Item'];?></td>
													<?php
								$queryselect = mysqli_query($conn, "SELECT * FROM ct_assignment_records where student='".$_SESSION['st_id']."' and assignment_id='$assignmentid';") or die(mysqli_error());
								if($rower = mysqli_fetch_array($queryselect))
								{ ?>
						<td> <a class="btn btn-warning btn-xs"> You Already Take the quiz </a></td>
								 <?php }else{?>
								<td> <a href="../st_main/st_at_assignment_take.php?assignment_id=<?php echo $row['assignment_id'];?>" class="btn btn-primary btn-xs"> Take Assignment </a></td>
								    <?php } ?>
								</tr> 
							    <?php } } ?>
